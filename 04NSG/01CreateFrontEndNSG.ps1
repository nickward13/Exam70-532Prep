...
$rule3 = New-AzureRmNetworkSecurityRuleConfig -Name outbound-web-rule -Description "Deny outbound Internet" `
...
Set-AzureRmVirtualNetworkSubnetConfig -Name "FrontEnd" -VirtualNetwork $vnet -AddressPrefix "10.0.1.0/24" -NetworkSecurityGroup $nsg
